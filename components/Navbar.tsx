        ...
        `}>
					<div className="flex items-center justify-between text-sm text-gray-500">
						<div className="flex items-center gap-4 mt-5">
							<a href="tel:+11234567890" className={'hover:text-indigo-800 transition-colors'}>
              <span className="flex items-center">
                ...
                +1 (555) 123-4567
							...
							<a className={'hover:text-indigo-800 transition-colors'} href="mailto:contact@rafiuzzamanrion.com">
